...
probe_file="Probe_feature_vector/preprocessed_110_8_features.txt"
jar_path="../cs.jar"
...
export SECRET_ID=$(java -jar "$jar_path" amphora create-secret $v_probe -t fingerprint=database -t accessPolicy=carbynestack.def -t authorizedPrograms=ephemeral-generic)
